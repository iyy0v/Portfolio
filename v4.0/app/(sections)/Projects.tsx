	...
	return (
		...
		>
			<Heading
				as="h1"
				size="72"
				className="text-3xl sm:text-5xl font-bold w-full min-h-16 overflow-visible text-center sm:text-left bg-clip-text text-transparent inline-block bg-gradient-to-b from-white to-blue-400"
			>
				Projects & Experience
			</Heading>

			<Flex direction="column" align="center" gap={10} w="100%">
...
const projects = [
	{
		title: "myEcom - E-Commerce ERP System | Front-end @ ZIMOU Group",
		description: `An E-Commerce ERP system designed to streamline online retail operations and help businesses manage their sales, inventory, delivery, agents and customer relationships more effectively.
      - Led the migration of the ERP codebase from Next.js to Vite, seamlessly replacing all Next.js-specific functionalities and ensuring system stability post-migration.
      - Collaborated closely with both front-end and back-end teams, identifying and resolving bugs across the stack and providing effective solutions to backend issues.
      - Contributed to the architecture and design of new features, defining technical approaches and implementation strategies in alignment with project goals.
      - Designed and developed UI components from scratch, often without pre-existing mockups, ensuring consistency, usability, and responsiveness.
      - Provided technical and strategic input to managers and the CTO on feature planning, system architecture, and product improvements.
      - Refactored legacy and unstable code to improve performance, maintainability, and scalability across the ERP platform.
      - Proposed and implemented enhancements to the ERP system, focusing on both technical efficiency and business value.
      - Delivered rapid and reliable bug fixes, maintaining high standards of code quality and system uptime.`,
		stack:
			"TypeScript, JavaScript, React, React Router, Next.js, Vite.js, i18next, REST API, Tanstack Query, Google APIs, HTML, CSS, TailwindCSS, MUI, Chart.js, Docker, Linux",
		images: ["/projects/myEcom/1.png"],
		linkUrl: "https://myecom.pro/",
	},
	{
		title:
			"Mail Algérie - Mail Tracking & Management | Software Engineer @ Air Algérie",
		description:
			"Developed a Progressive Web Application to optimize and modernize Air Algérie's mail management process, enhancing efficiency and ensuring document traceability. The application features a user-friendly interface for visualizing, adding, modifying, and deleting incoming and outgoing mails, supports OCR for mail digitization and Gemini AI for content auto-correction, and facilitates document sharing and collaboration. It includes mail searching/filtering, automatic alerts for response deadlines and other notifications, multilingual support, mobile adaptability and offline disponibility. The application also includes administration features for managing structures, users, roles, permissions, mails, viewing audit logs and generating reports.",
		stack:
			"TypeScript, React, Redux, React-Query, Next.js, HTML, TailwindCSS, Python, Nginx, Django, PostgreSQL, GraphQL, Firebase Cloud Messaging, Gemini API, Tesseract",
		images: [
	...
	},
	{
      ...
      - Multiple accounts can be added to the account list for quick access.`,
		...
		githubUrl: "https://github.com/iyy0v/LOL-analyzer",
	},
	{
		title: "Flite - E-tourism plateform (Front-end)",
		description:
			"Created a responsive front end of an e-tourism plateform for traveling offers. Traveling agencies can post their offers while clients can search, filter, save and share those offers. The plateform includes a user-friendly interface, supports authentication and have an administration panel.",
